...
![image](11.1.3_CompacOnlineV2_Sites_Page.png)

Click on the status button ![image](11.1.4_CompacOnlineV2_Sites_Page_1.png) of a site will display the high-level status of the Terminal, Pumps, Tanks and Forecourt Controller.

![image](11.1.5_CompacOnlineV2_Sites_Page_2.png)

Under Sites, the following options are available:

![image](11.1.6_CompacOnlineV2_Sites_Page_3.png)

- Site Details – this page lists the site details: Site Name, Currency, Address, Tax Rate and Tax Identifier.

![image](11.1.7_CompacOnlineV2_Sites_Page_4.png)

<BR>

- Terminals – displays a list of terminals connected to site

![image](11.1.8_CompacOnlineV2_Sites_Page_5.png)
...
![image](11.1.11_CompacOnlineV2_Sites_Page_8.png)

<BR>

Under “Operations”, you may see more options based on your permission levels

![image](11.1.12_CompacOnlineV2_Sites_Page_9.png)

<BR>

- Pumps & Hoses – displays all pumps and hoses configured for this site

![image](11.1.13_CompacOnlineV2_Sites_Page_10.png)

<BR>

Pump configuration can be viewed by selecting each pump number.

![image](11.1.14_CompacOnlineV2_Sites_Page_11.png)

![image](11.1.15_CompacOnlineV2_Sites_Page_12.png)

<BR>

- Tanks – displays the Tank/s configured for site

![image](11.1.16_CompacOnlineV2_Sites_Page_13.png)
...
- Price Sign – displays the Price Sign configured for the site

![image](11.1.17_CompacOnlineV2_Sites_Page_14.png)

Price Sign details can be viewed by selecting the Price Sign

<BR>

![imge](11.1.18_CompacOnlineV2_Sites_Page_15.png)

<BR>

- Forecourt Controllers – displays the forecourt controller that your Compac OPT is connected to.

![image](11.1.19_CompacOnlineV2_Sites_Page_16.png)

<BR>

- Receipt Templates – displays the receipt template of each BIN Range

![image](11.1.20_CompacOnlineV2_Sites_Page_17.png)

<BR>

![image](11.1.21_CompacOnlineV2_Sites_Page_18.png)
...
![image](11.2.3_CompacOnlineV2_Transactions_3.png)

- On the Sidebar, select **Transactions**

![image](11.2.4_CompacOnlineV2_Transactions_4.png)

<BR>

- Select ![image](11.2.5_CompacOnlineV2_Transactions_5.png) on the top right of the transaction page to set the filter.<BR>
In the filter, select the correct site name, Date Range and input the card number then click on ‘Apply’.

![image](11.2.6_CompacOnlineV2_Transactions_6.png)

- Now all the transactions you want to check are listed as following screen shot.

![image](11.2.7_CompacOnlineV2_Transactions_7.png)

Transactions can be exported from CompacOnline. To export transactions, select ![image](11.2.8_CompacOnlineV2_Transactions_8.png) from the top right corner of the page.

There are currently 3 type of exports available. Transaction export is only available in CSV format. Transaction Totals Card Scheme and Transaction Totals Product can be exported in CSV or pdf format.<BR>
...
![image](11.2.12_CompacOnlineV2_Transactions_12.png)
...
![image](11.2.13_CompacOnlineV2_Transactions_13.png)

To add columns, select ![image](11.2.14_CompacOnlineV2_Transactions_14.png) Select the missing columns and select Add

![image](11.2.15_CompacOnlineV2_Transactions_15.png)
...
![image](11.3.1_CompacOnlineV2_Products_1.png)
...
![image](11.4.1_CompacOnlineV2_Price_1.png)

Each price schedule can be applied to a single or multiple sites within the Organisation, a site can only have one price schedule linked to it.

![image](11.4.2_CompacOnlineV2_Price_2.png)
...
![image](11.5.1_CompacOnlineV2_Cards_1.png)
...
![image](11.5.2_CompacOnlineV2_Cards_2.png)
...
![image](11.6.1_CompacOnlineV2_Users_1.png)
...
**Users** - This page displays all local *Users* created for the *Site*

![image](11.6.2_CompacOnlineV2_Users_2.png)

To create a new user, select Create User and enter all requried details

![image](11.6.3_CompacOnlineV2_Users_3.png)

Mobile number is only required if this user needs to receive Txt Alert. Otherwise leave it blank.<BR>
...
![image](11.6.4_CompacOnlineV2_Users_4.png)

Inviting a *Guest* user, select the drop down option

![image](11.6.5_CompacOnlineV2_Users_5.png)

![image](11.6.6_CompacOnlineV2_Users_6.png)
...
![image](11.7.1_CompacOnlineV2_Monitor_1.png)

![image](11.7.2_CompacOnlineV2_Monitor_2.png)
...
- **Activity Logs** – activities relating to an organisation or a site will be listed on this page

![image](11.7.3_CompacOnlineV2_Monitor_3.png)

**Alerts** – selecting this page displays all alert history triggered for an organisation or site/s.

![image](11.7.4_CompacOnlineV2_Monitor_4.png)

To set up an alert, a user group must be created before an *Alert Rule* can be configured. Select *User Groups* and *Create New*.

![image](11.7.5_CompacOnlineV2_Monitor_5.png)

![image](11.7.6_CompacOnlineV2_Monitor_6.png)
...
![image](11.7.7_CompacOnlineV2_Monitor_7.png)

![image](11.7.8_CompacOnlineV2_Monitor_8.png)
